#include <omo/chain/types.hpp>

#include <omo/net_plugin/net_plugin.hpp>
#include <omo/net_plugin/protocol.hpp>
#include <omo/chain/chain_controller.hpp>
...
namespace omo {
  ...
  void net_plugin::set_program_options( options_description& cli, options_description& cfg )
  {
    cfg.add_options()
      ...
      ("agent-name", bpo::value<string>()->default_value("OMO Test Agent"), "The name supplied to identify this node amongst the peers.")
      ;
  }
