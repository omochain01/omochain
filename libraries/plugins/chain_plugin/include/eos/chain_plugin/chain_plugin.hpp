...
FC_REFLECT(omo::chain_apis::empty, )
FC_REFLECT(omo::chain_apis::read_only::get_info_results,
           (head_block_num)(head_block_id)(head_block_time)(head_block_producer)
           (recent_slots)(participation_rate))
FC_REFLECT(omo::chain_apis::read_only::get_block_params, (block_num_or_id))
