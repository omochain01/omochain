...
FC_REFLECT( omo::handshake_message,
            (network_version)(chain_id)(node_id)
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id)
            (os)(agent) )

FC_REFLECT( omo::block_summary_message, (block)(trx_ids) )
FC_REFLECT( omo::notice_message, (known_trx)(known_blocks) )
FC_REFLECT( omo::sync_request_message, (start_block)(end_block) )
FC_REFLECT( omo::peer_message, (peers) )
